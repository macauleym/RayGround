...
public class SimpleShadowsRenderer(IExportCanvas exporter, ILogable logger) : Renderer(exporter, logger)
{
    ...
    {
        var simpleShadowsCanvas = await SimpleShadowTest();
        await ExportCanvasAsync(simpleShadowsCanvas, "camera-view-shadows.ppm");
    }
}
